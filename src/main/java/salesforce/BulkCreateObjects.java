...
public class BulkCreateObjects {
    public static void main(String[] args)
            throws AsyncApiException, ConnectionException, IOException {
        BulkCreateObjects example = new BulkCreateObjects();
        // The first parameter indicates that we are loading Account records
        example.runSample("Account", "spanadmin@spanningtest.com", "zdf52%n@XVv0", "mySampleData.csv");
//        example.runSample("sca__KateProduct__c", "spanadmin@spanningtest.com", "zdf52%n@XVv0", "mySampleData1.csv");
